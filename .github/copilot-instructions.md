...
**CRITICAL**: This Copilot configuration is coupled with the root `CLAUDE.md` file.

### Mandatory Document Reading Order

| Order | Document | Path |
|-------|----------|------|
| 1 | Root Agent Rules | `CLAUDE.md` |
| 2 | Workflow Guide | `WORKFLOW.md` |
| 3 | Constitution | `constitution-prompt-phase-2.md` |
| 4 | Specification | `spec-prompt-phase-2.md` |
| 5 | Plan | `plan-prompt-phase-2.md` |

### Agent Delegation (Same as CLAUDE.md)

| Task Type | Agent | Trigger |
|-----------|-------|--------|
| FastAPI, services, middleware | `@backend-api-builder` | Any backend code |
...
**Before ANY implementation, fetch documentation:**
- `nextjs`, `fastapi`, `sqlmodel`, `better-auth`
- `shadcn-ui`, `framer-motion`, `tailwindcss`
- `zustand`, `axios`, `aceternity-ui`
...
See `CLAUDE.md` for complete branch lifecycle.

---

## Basic Project Structure

- `CLAUDE.md` — Root agent orchestrator (READ FIRST)
- `constitution-prompt-phase-2.md` — Project principles
- `spec-prompt-phase-2.md` — Feature requirements
- `plan-prompt-phase-2.md` — Implementation plan
- `.specify/memory/constitution.md` — SpecKit constitution
- `specs/` — Feature, API, DB, UI specifications
