...
- MCP Server: Minimal base image, no unnecessary packages
...
**Description**: Changes to infrastructure should be deploy-only, no in-place modifications.
...
│                                                                 │
│  4. LOCAL DEPLOYMENT (Minikube)                             │
│     ├─> @minikube-setup                                       │
│     ├─> Start Minikube (4 CPU, 8GB RAM)                       │
...
│     ├─> Use Docker AI for optimization                        │
│     └─> Use Kagent for cluster health                         │
│                                                                 │
...
```
```
DATABASE_URL=<from ConfigMap or Secret>
